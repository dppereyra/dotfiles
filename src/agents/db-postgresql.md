...
color: blue
primary: false
delegates: dev-backend, dev-go, dev-javascript, dev-kotlin, dev-python, dev-typescript, ops-aws, ops-azure, ops-container, ops-google-cloud, ops-kubernetes, ops-security

...
agents: ["db-elasticsearch", "db-mysql", "db-postgresql", "dev-backend", "dev-go", "dev-javascript", "dev-kotlin", "dev-python", "dev-typescript", "ops-aws", "ops-azure", "ops-container", "ops-google-cloud", "ops-kubernetes", "ops-security"]
user-invocable: true

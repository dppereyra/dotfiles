...
agents: ["db-sqlite", "dev-backend", "dev-flutter", "dev-javascript", "dev-kotlin", "dev-typescript", "mgr-product-owner", "mgr-recruiter", "ops-security", "qa-conftest", "qa-playwright", "qa-reviewer-1", "qa-reviewer-2", "qa-reviewer-3", "qa-robot-framework"]
user-invocable: true

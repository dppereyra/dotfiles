...
agents: ["db-elasticsearch", "db-mongodb", "db-mysql", "db-postgresql", "db-redis", "db-sqlite", "dev-backend", "ops-azure-devops", "ops-container", "ops-github", "ops-gitlab", "ops-security", "qa-playwright", "qa-robot-framework", "rnd-library"]
user-invocable: true

...
agents: ["mgr-product-owner", "mgr-recruiter", "ops-automation", "ops-aws", "ops-azure", "ops-google-cloud", "ops-k3s", "ops-kubernetes", "ops-openshift", "ops-security", "ops-terraform", "qa-conftest", "qa-playwright", "qa-reviewer-1", "qa-reviewer-2", "qa-reviewer-3", "qa-robot-framework"]
user-invocable: true

...
agents: ["mgr-product-owner", "mgr-recruiter", "ops-ansible", "ops-architect", "ops-argocd", "ops-azure-devops", "ops-chef", "ops-fluxcd", "ops-github", "ops-gitlab", "ops-salt", "ops-terraform", "qa-conftest", "qa-playwright", "qa-reviewer-1", "qa-reviewer-2", "qa-reviewer-3", "qa-robot-framework"]
user-invocable: true

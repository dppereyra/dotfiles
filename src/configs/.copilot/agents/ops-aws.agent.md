...
agents: ["db-elasticsearch", "db-mysql", "db-postgresql", "db-redis", "ops-bitwarden", "ops-container", "ops-doppler", "ops-github", "ops-gitlab", "ops-kubernetes", "ops-security", "ops-terraform"]
user-invocable: true

...
agents: ["dev-go", "dev-python", "ops-ansible", "ops-azure-devops", "ops-chef", "ops-dinit", "ops-github", "ops-gitlab", "ops-linux", "ops-powershell", "ops-salt", "ops-systemd", "ops-taskfile"]
user-invocable: true

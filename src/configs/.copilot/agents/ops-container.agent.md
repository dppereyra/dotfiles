...
agents: ["ops-ansible", "ops-artix", "ops-bitwarden", "ops-debian", "ops-devuan", "ops-dinit", "ops-doppler", "ops-fedora", "ops-k3s", "ops-kubernetes", "ops-openmandriva", "ops-openshift", "ops-security", "ops-supervisord", "ops-systemd"]
user-invocable: true

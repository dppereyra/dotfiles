...
agents: ["mgr-product-owner", "mgr-recruiter", "ops-ansible", "ops-artix", "ops-bash", "ops-chef", "ops-container", "ops-debian", "ops-devuan", "ops-dinit", "ops-fedora", "ops-openmandriva", "ops-salt", "ops-security", "ops-systemd", "qa-conftest", "qa-playwright", "qa-reviewer-1", "qa-reviewer-2", "qa-reviewer-3", "qa-robot-framework"]
user-invocable: true

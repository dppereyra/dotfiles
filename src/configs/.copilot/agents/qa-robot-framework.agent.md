...
agents: ["db-mongodb", "db-mysql", "db-postgresql", "dev-backend", "dev-frontend", "dev-python", "mgr-product-owner", "ops-azure-devops", "ops-container", "ops-github", "ops-gitlab", "qa-playwright", "qa-reviewer-1", "qa-reviewer-2", "qa-reviewer-3"]
user-invocable: true

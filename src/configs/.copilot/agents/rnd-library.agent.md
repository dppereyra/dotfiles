...
agents: ["dev-backend", "dev-flutter", "dev-frontend", "dev-go", "dev-javascript", "dev-kotlin", "dev-mobile", "dev-python", "dev-typescript", "dev-zig", "mgr-product-owner", "mgr-recruiter", "ops-security", "qa-conftest", "qa-playwright", "qa-reviewer-1", "qa-reviewer-2", "qa-reviewer-3", "qa-robot-framework"]
user-invocable: true
